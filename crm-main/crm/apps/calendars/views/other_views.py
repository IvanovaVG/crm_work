...
class EventEdit(generic.UpdateView):
    ...
    template_name = 'common/event.html'
...
def event_details(request, event_id):
    ...
    return render(request, 'common/event-details.html', context)
...
def add_eventmember(request, event_id):
    ...
    return render(request, 'common/add_member.html', context)


class EventMemberDeleteView(generic.DeleteView):
    model = EventMember
    template_name = 'common/event_delete.html'
